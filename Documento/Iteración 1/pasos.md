...
|------|------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| DEC-1 | App front y back serán deployeados en un EC2         | Amazon EC2 es elegido para el despliegue de la plataforma educativa debido a su capacidad de escalamiento automático, permitiendo ajustar los recursos de acuerdo con la demanda. Esta flexibilidad es vital para una plataforma educativa que puede experimentar variaciones significativas en la carga de trabajo, por ejemplo, durante exámenes o periodos de inscripción. La alta disponibilidad y el rendimiento garantizado de EC2 aseguran que los usuarios tengan acceso continuo y rápido a la plataforma, lo cual es esencial para mantener la calidad del servicio educativo. Además, la integración con otros servicios de AWS como CloudWatch y IAM facilita la gestión y monitoreo de la infraestructura, proporcionando una capa adicional de seguridad y estabilidad. |
