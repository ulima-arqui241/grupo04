...
|    Jefe del proyecto   |  Josemaria Pérez | Responsable de la planificación, ejecución y supervisión del proyecto. Coordina al equipo de desarrollo, asegura el cumplimiento de plazos y objetivos, y gestiona los recursos necesarios para el desarrollo de la plataforma. |
...
|         Tester        |  Josemaria Pérez | Realiza pruebas exhaustivas para garantizar que las funcionalidades de la plataforma funcionen correctamente y cumplan con los requisitos especificados. Asegura la calidad del software antes de su despliegue. |
