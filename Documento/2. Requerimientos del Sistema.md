...
| Escalabilidad | RCM-03    | Sistema de chat            | Equipo de desarrollo      | Aumento en el número de mensajes       | Sistema de chat             | El sistema debe soportar un aumento en el volumen de mensajes enviados    | Hasta 20000 mensajes por minuto             |
| Seguridad     | RCM-04    | Sistema de chat            | Equipo de desarrollo      | Mensajes enviados                     | Sistema de chat             | Los mensajes deben ser transmitidos de forma segura                       | Cifrado de extremo a extremo                |
...
| Seguridad     | RAM-02    | Sistema de administración  | Administradores           | Intentos de acceso no autorizado       | Sistema de administración   | El sistema debe proteger los datos confidenciales                         | Máximo 3 intentos de acceso antes de bloqueo|
| Usabilidad    | RAM-03    | Interfaz de administración | Administradores           | Interacción con la interfaz            | Interfaz de administración  | La interfaz debe ser intuitiva y fácil de usar para los administradores    | Satisfacción del usuario mayor al 80%       |
